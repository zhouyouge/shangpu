...
function addshopPrice() {
   /* alert("一铺一价信息添加");*/
    $('#wodezhuomian').attr('src', 'fenchang/Commer-add.jsp');
    $("#type").val(1);
}
...
/*alert("一铺一价修改"+ashopId);*/
    window.parent.location.href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/Commer-add.jsp'&&ashopId="+ashopId;

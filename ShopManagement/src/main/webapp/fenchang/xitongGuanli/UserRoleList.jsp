...
<![endif]-->
<title>用户角色对照信息管理</title>
</head>
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>权限 <span class="c-gray en">&gt;</span> 用户角色对照信息管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div id="div" class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="deleteUserRoleAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		<a href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/UserRole-add.jsp'"  class="btn btn-primary radius" target="_parent">
			<i class="Hui-iconfont">&#xe600;</i> 添加用户角色对照信息
		</a>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c">
				...
				<th width="100">对照表ID</th>
				<th width="100">用户ID/用户名称</th>
				<th width="100">用户权限级别</th>
				<th width="100">角色ID/角色名称</th>
				<th width="100">用户角色描述</th>
				<th width="100">角色对照信息创建时间</th>
				<th width="100">角色对照信息修改时间</th>
				<th width="100">操作</th>
			</tr>
			</thead>
			<tbody>
...
<div id="hidden5">
	<input  type="hidden" value="UserRoleList" id="yemian"/>
</div>
<!--_footer 作为公共模版分离出去-->

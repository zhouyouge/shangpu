...
<div class="page-container">
	...
	<div id="div" class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="deleteRoleAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		<a href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/Role-add.jsp'"  class="btn btn-primary radius" target="_parent">
			<i class="Hui-iconfont">&#xe600;</i> 添加角色信息
		</a>
				<a  href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/xitongGuanli/noroleList.jsp'"  class="btn btn-primary radius" target="_parent">
			<span id="aa">未启用角色信息全查</span>
		</a>
						<a  href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/xitongGuanli/roleList.jsp'"  class="btn btn-primary radius" target="_parent">
			 <span id="bb">已启用角色信息全查</span>
		</a>
		</span>
		<span class="r"></span>
	</div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c">
				...
				<th width="100">角色创建时间</th>
				<th width="100">角色修改时间</th>
				<th width="100">操作</th>
			</tr>
			</thead>
			<tbody>
...
<div id="hidden5">
	<input  type="hidden" value="RoleList" id="yemian"/>
</div>
<!--_footer 作为公共模版分离出去-->

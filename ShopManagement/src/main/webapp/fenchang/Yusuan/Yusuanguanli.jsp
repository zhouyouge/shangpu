...
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <label>
        <a class="biaoqian">1月<input value="1" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="yiyue">&emsp;</a>
        </label>
        <label>
        <a class="biaoqian">2月<input value="2" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="eryue">&emsp;</a>
        </label>
        <label>
        <a class="biaoqian">3月<input value="3" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="sanyue">&emsp;</a>
        </label>
        <label>
        <a class="biaoqian">4月<input value="4" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="siyue">&emsp;</a>
        </label>
        <label>
        <a class="biaoqian">5月<input value="5" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="wuyue">&emsp;</a>
        </label>
        <label>
        <a class="biaoqian">6月<input value="6" onclick="dianji(this)" type="checkbox" name="yue" class="ids" id="liuyue">&emsp;</a>
        </label>
...
<div id="hidden5">
    <input  type="hidden" value="Yusuan-list" id="yemian"/>
</div>
<!--_footer 作为公共模版分离出去-->

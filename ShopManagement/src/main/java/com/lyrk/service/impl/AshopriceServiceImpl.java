...
public class AshopriceServiceImpl implements AshopriceService {
    ...
    @Override
    public List<Ashopprice> getAshopirceList() {
        return ashopPriceDao.getAshopirceList();
    }

    @Override
    public boolean addAshopprice1(Ashopprice ashopprices) {
        return ashopPriceDao.addAshopprice(ashopprices)>0;
    }
}

	...
	<%--<form class="form form-horizontal" &lt;%&ndash;id="form-article-add"&ndash;%&gt;>--%>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="xiugaitenementsubmit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 修改并提交审核</button>
				<button onClick="addtenementsubmit();" class="btn btn-primary radius" type="submit" id="addtenementsubmit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>

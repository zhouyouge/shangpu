...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据管理 <span class="c-gray en">&gt;</span>楼层信息管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入楼层名称" id="floorName" name="floorName">
		<button type="button" id="qingchuTime"  class="btn btn-success radius" onclick="cleanTime()" name="">清除时间</button>
		<button type="submit" class="btn btn-success radius" onclick="Floortjchaxun()" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜楼层</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/floor-add.jsp'" <%--onclick="javascript:addaticle2()"--%> class="btn btn-primary radius" target="_parent"><i class="Hui-iconfont">&#xe600;</i> 添加楼层信息</a></span> <span class="r"></span> </div>
	<div class="mt-20">
...
<div id="hidden3">
	<input  type="hidden" value="FloorList" id="yemian"/>
</div>
<%--<table id="aaaa">

	...
	<div class="form form-horizontal">
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onClick="updateBoothSumbit();" class="btn btn-primary radius" type="submit" id="updateBoothSumbit"><i class="Hui-iconfont">&#xe632;</i> 修改并提交审核</button>
				<button onClick="addBoothSumbit();" class="btn btn-primary radius" type="submit" id="addBoothSumbit"><i class="Hui-iconfont" >&#xe632;</i> 保存并提交审核</button>

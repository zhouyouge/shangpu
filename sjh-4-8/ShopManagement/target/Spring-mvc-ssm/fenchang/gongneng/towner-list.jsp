...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据管理 <span class="c-gray en">&gt;</span> 楼栋信息管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入楼栋名称" id="towerName" name="towerName">
		<button type="button" id="qingchuTime"  class="btn btn-success radius" onclick="cleanTime()" name="">清除时间</button>
		<button  class="btn btn-success radius" onclick="TownerTiaojian()" name=""><i class="Hui-iconfont">&#xe665;</i> 搜楼栋</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteAllTowner()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/townerContract-add.jsp'" class="btn btn-primary radius" target="_parent"><i class="Hui-iconfont">&#xe600;</i> 添加楼栋信息</a></span> <span class="r"></span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tr class="text-c">
				...
				<th width="80">分场名称</th>
				<th width="100">楼栋编码</th>
				<th width="130">楼栋名称</th>
				<th width="130">楼栋状态</th>
				<th width="70">建筑面积</th>
				<th width="70">经营面积</th>
				<th width="70">地上楼层数</th>
				<th width="70">地下楼层数</th>
				<th width="70">备注</th>
				<th width="70">楼栋图</th>
				<th width="70">楼栋信息状态</th>
				<th width="75">创建时间</th>
				<th width="75">修改时间</th>
				<th width="100">操作</th>
			</tr>
...
<div id="hidden2">
	<input  type="hidden" value="townerList" id="yemian"/>
</div>
<%--<table id="aaaa">

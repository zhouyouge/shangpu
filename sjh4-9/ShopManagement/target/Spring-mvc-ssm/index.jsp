        ...
        <dl id="menu-article" >
            ...
            <dd >
                <ul>
                    ...
                    <li><a  data-title="资讯管理" onclick="javascript:addBrandinformation()">新增品牌信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl >
        ...
        <dl id="menu-product" >
            ...
            <dd>
                <ul>
                    ...
                    <li><a  data-title="产品管理" onclick="queryBankAccountList()">银行账户信息管理</a></li>
                    <li><a  data-title="产品管理" onclick="queryBillinformationExpressionList()">开票信息管理</a></li>
                    <li><a  data-title="产品管理" onclick="queryBrandinformationList()">品牌信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
...
<script>
   ...
   if(request.getParameter("boothNumber")!=null){
    ...
    if(request.getParameter("goHourseId")!=null){
         String goHourseId=request.getParameter("goHourseId");
         session.setAttribute("goHourseId",goHourseId);
    }
    if(request.getParameter("getheringId")!=null){
         String getheringId=request.getParameter("getheringId");
         session.setAttribute("getheringId",getheringId);
    }
    if(request.getParameter("breakId")!=null){
         String breakId=request.getParameter("breakId");
         session.setAttribute("breakId",breakId);
    }
...
<script type="text/javascript" src="js/huoyanyi/js/pinpai.js"></script><%--品牌操作js--%>

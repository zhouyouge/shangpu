...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 数据管理 <span class="c-gray en">&gt;</span> 品牌信息管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <div class="text-c"> 日期范围：
        ...
        <input type="text" class="input-text" style="width:250px" placeholder="输入品牌名称" id="brandCoding" name="diversifiedName" />
        <button type="button" id="qingchuTime"  class="btn btn-success radius" onclick="cleanTime()" name="">清除时间</button>
        <button type="button" onclick="pinpaichaxun()" class="btn btn-success radius"  name=""><i class="Hui-iconfont">&#xe665;</i> 搜品牌</button>
    </div>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="deleteAll()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="http://localhost:8080/ShopManagement/index.jsp?name='fenchang/diversified-add.jsp'" <%--onclick="javascript:addaticle2()"--%> class="btn btn-primary radius" target="_parent"><i class="Hui-iconfont">&#xe600;</i> 添加品牌信息</a></span> <span class="r"></span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="80">主键ID</th>
                <th width="100">品牌编码</th>
                <th width="130">品牌名称(中)</th>
                <th width="130">品牌名称(英)</th>
                <th width="130">所属业态</th>
                <th width="70">品牌发源地</th>
                <th width="70">连锁/单店</th>
                <th width="70">经营性质</th>
                <th width="70">官方网址</th>
                <th width="70">总部地址</th>
                <th width="70">品牌说明</th>
...
<div id="hidden5">
    <input  type="hidden" value="Brandinformation" id="yemian"/>
</div>
<!--_footer 作为公共模版分离出去-->

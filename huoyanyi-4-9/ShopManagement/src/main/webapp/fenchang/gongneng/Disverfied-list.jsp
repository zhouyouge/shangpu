...
<div class="page-container">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入多经名称" id="diversifiedName" name="diversifiedName" />
		<button type="button" id="qingchuTime"  class="btn btn-success radius" onclick="cleanTime()" name="">清除时间</button>
		<button type="button" onclick="duojingtjchaxun()" class="btn btn-success radius"  name=""><i class="Hui-iconfont">&#xe665;</i> 搜多经</button>
	</div>

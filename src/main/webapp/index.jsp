...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.html">商铺管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.html">H-ui</a>
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">版本v1.0</span>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article" >
            ...
            <dd >
                <ul>
                    <li><a data-href="404.jsp" data-title="资讯管理" onclick="javascript:addbreakout()">分场信息管理</a></li>
        ...
        <dl id="menu-product" >
            ...
            <dd>
                <ul>
                    <li><a data-href="product-brand.html" data-title="品牌管理" href="javascript:void(0)">分场信息修改</a></li>
                    <li><a data-href="product-category.html" data-title="分类管理" href="javascript:void(0)">楼栋信息修改</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" href="javascript:void(0)">楼层信息修改</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
        ...
        <dl id="yetaiguanli">
            ...
            <dd>
                <ul>
                    <li><a  onclick="javascript:getCommers()">业态列表</a></li>
                    <li><a data-href="member-del.jsp" data-title="删除的会员" href="javascript:;">删除的会员</a></li>
                    <li><a data-href="member-level.jsp" data-title="等级管理" href="javascript:;">等级管理</a></li>
                    <li><a data-href="member-scoreoperation.jsp" data-title="积分管理" href="javascript:;">积分管理</a></li>
                    <li><a data-href="member-record-browse.jsp" data-title="浏览记录" href="javascript:void(0)">浏览记录</a></li>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" <%--src="welcome.jsp"--%> id="wodezhuomian">
               <%-- <div id="commers"></div>--%>
            </iframe>
        </div>
    </div>

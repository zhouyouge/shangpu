...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<label for="towerStatus1">
					<input type="radio" name="allowcomments" id="towerStatus1" value="楼栋状态" checked="checked"/>可租&emsp;&emsp;&emsp;
				</label>
				<label for="towerStatus2">
					<input type="radio"  name="allowcomments" id="towerStatus2" value="楼栋状态"/>不可组&emsp;&emsp;&emsp;
				</label>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<label for="tower_BreakoutStatus1">
					<input type="radio" name="allowcomments2" id="tower_BreakoutStatus1" value="楼栋信息状态" checked="checked"/>信息可用&emsp;&emsp;&emsp;
				</label>
				<label for="tower_BreakoutStatus2">
					<input type="radio"  name="allowcomments2" id="tower_BreakoutStatus2" value="楼栋信息状态"/>信息不可用&emsp;&emsp;&emsp;
				</label>
				<label for="tower_BreakoutStatus3">
					<input type="radio"  name="allowcomments2" id="tower_BreakoutStatus3" value="楼栋信息状态"/>审核中<br/>
				</label>
			</div>
		</div>
		...
		<br/>
		<div style="background-color: rgba(0,176,240,0.5)">新增房屋来源信息(多记录)</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value=""  id="startTime" name="startTime">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value=""  id="outTime" name="outTime">
			</div>
		</div>

...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article" >
            ...
            <dd >
                <ul>
                    <li><a data-href="404.jsp" data-title="资讯管理" onclick="javascript:addbreakout()">新增分场信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:addtower()">新增楼栋信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:addfloor()">新增楼层信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:addbooth()">新增摊位信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:addtenement()">新增租户信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:addshopPrice()">新增一铺一价信息</a></li>
                    <li><a data-href="article-list.jsp" data-title="资讯管理" onclick="javascript:adddiversified()">新增多经信息</a></li>
                </ul>
            </dd>
        </dl>
        <dl >
        ...
        <dl id="menu-product" >
            ...
            <dd>
                <ul>
                    <li><a data-href="product-brand.html" data-title="品牌管理" onclick="javascript:queryArticleList()">分场信息管理</a></li>
                    <li><a data-href="product-category.html" data-title="分类管理" onclick="queryTownerPriceList()">楼栋信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryFloorList()">楼层信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryBoothList()">摊位信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryTenementList()">租户信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryAshopPriceList()">一铺一价信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryDiversidiedList()">多经信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryHousingSource()">房屋来源信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryHouseSourceList()">房屋去向信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryPaymentTermList()">收款方信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryTownercontractList()">甲方合同信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryBankAccountList()">银行账户信息管理</a></li>
                    <li><a data-href="product-list.html" data-title="产品管理" onclick="queryBillinformationExpressionList()">开票信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-comments">
...
<script>
   if( $("#hidden").val()!=null){
       $('#wodezhuomian').attr('src',<%=request.getParameter("name")%> );
   };
</script>
<!--_footer 作为公共模版分离出去-->

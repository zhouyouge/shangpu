...
<c:if test="${not empty queryHouseSourceList}">
    <c:forEach items="${queryHouseSourceList.data.houseSourceList}" var ="queryHouseSourceList">
        <tr class="text-c">
            <td><input type="checkbox" value="1" name=""></td>
            <td>${queryHouseSourceList.hoseSource}</td>
            <td>${queryHouseSourceList.produceLabel}</td>
            <td>${queryHouseSourceList.propertyOwner}</td>
            ...
            <td>${queryHouseSourceList.gatheringId}</td>

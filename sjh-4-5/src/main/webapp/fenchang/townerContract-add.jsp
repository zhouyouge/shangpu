...
<article class="page-container">
	<%--<form class="form form-horizontal" &lt;%&ndash;id="form-article-add"&ndash;%&gt;>--%>
		...
		<br/>
		<div style="background-color: rgba(0,176,240,0.5)">新增楼栋信息</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'commentdatemax\')||\'%y-%M-%d\'}' })" id="commentdatemin" name="commentdatemin" class="input-text Wdate">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" onfocus="WdatePicker({ dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'commentdatemin\')}' })" id="commentdatemax" name="commentdatemax" class="input-text Wdate">
			</div>
		</div>
		...
		<br/>
		<div style="background-color: rgba(0,176,240,0.5)" name="aaa">新增房屋来源信息(多记录)</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>房屋来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<select id="hoseSource">
				<option value="自有产权">自有产权</option>
				<option value="内部租凭">内部租凭</option>
				<option value="委托管理">委托管理</option>
				<option value="使用权租凭">使用权租凭</option>
				<option value="社会租凭">社会租凭</option>
			</select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value=""  id="hoursestartTime" name="startTime">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="date" class="input-text" value=""  id="hourseoutTime" name="outTime">
			</div>
		</div>

		<br/>
		<div style="background-color: rgba(0,176,240,0.5)">新增房屋去向信息</div>

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">房屋去向：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<select id="hourseGoDown">
					<option value="社会租凭">社会租凭</option>
					<option value="内部租凭">内部租凭</option>
					<option value="委托租凭">委托租凭</option>
				</select>
			</div>
		</div>
		...
		<br/>
		<div style="background-color: rgba(0,176,240,0.5)">新增收款方信息(多记录)</div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
				<button onclick="addTowerSumbit();" class="btn btn-primary radius" type="submit"><i class="Hui-iconfont">&#xe632;</i> 保存并提交审核</button>
